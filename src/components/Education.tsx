  ...
  const timeline = [
    {
      ...
      details: [
        'Focusing on foundational concepts in computer science, logic development, and numerical mathematics.',
        'Core Subjects: Problem Solving using C, Python Programming, Linear Algebra & Calculus, Computer Graphics basics.',
        'Active member of the University Technical/AI Club, participating in coding meetups.',
      ],
    },
    {
      type: 'past',
      degree: 'Senior Secondary / Pre-University Education (Grade XII)',
      institution: 'Science Stream (PCMC)',
      duration: '2023 - 2025',
      location: 'Bengaluru, India',
      status: 'Completed',
      details: [
        'Specialization: Physics, Chemistry, Mathematics, and Computer Science.',
        'Developed early coding interest by implementing basic control structures and algorithms in Python/C++.',
        'Maintained a strong academic record with high focus on mathematics and analytical concepts.',
      ],
    },
    {
      type: 'past',
      ...
      status: 'Completed',
      details: [
        'Acquired strong foundations in Science, Mathematics, and logical reasoning.',
        'Participated in science exhibitions, logic olympiads, and school-level math quizzes.',
      ],
    },
  ];
